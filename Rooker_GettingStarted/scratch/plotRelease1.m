...
dye = find((date>=datenum('03-Jul-2024 18:38:00')) & (date>=datenum('03-Jul-2024 19:52:00')));
 for bindex = 1:size(b1,2)
     ...
     for beam = 1:3
     % Generate a figure
         tsf = figure('name',[ 'Beam ' num2str(beam)]);
     ...
     % Plot data
         ...
         xlabel(ax3, 'Time (s)');
     % Export Figure
         figname = ["C:\Users\jkr6136\OneDrive - UNC-Wilmington\Kelp_data\Summer2025\Rooker\figures\timeseries\ts_r1_beam" + beam + "_bin" + bindex + ".pdf"];
